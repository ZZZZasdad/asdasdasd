if getgenv().Yuuki then 
	if game.CoreGui:FindFirstChild("Yuuki Hub GUI") then for i, v in ipairs(game.CoreGui:GetChildren()) do if string.find(v.Name,  "Yuuki Hub") then v:Destroy() end end end
end
getgenv().Yuuki = true
...
local T1UIColor = {
	...
	["Logo Image"] = "http://www.roblox.com/asset/?id=105527443155341",
...
local IndexUIColor = {
	...
	["Click Effect Color"] = Color3.fromRGB(230, 230, 230),
	["Setting Icon Color"] = Color3.fromRGB(230, 230, 230),
	["Logo Image"] = "rbxassetid://105527443155341",
	["Search Icon Color"] = Color3.fromRGB(255, 255, 255),
...
Library_Function.Gui.Name = 'Yuuki Hub GUI'
...
Library.ToggleUI = function()
	...
	if game.CoreGui:FindFirstChild("Yuuki Hub GUI")then for a,b in ipairs(game.CoreGui:GetChildren())do if b.Name=="Yuuki Hub GUI"then b.Enabled= getgenv().UIToggled end end end
end
...
local libCreateNoti = function(Setting)
	...
	TextLabelNoti.Text = "<font color=\"rgb(" .. color .. ")\">Yuuki Hub</font> "..getgenv().TitleNameNoti
...
function Library.CreateMain(Setting)
	...
	local TitleNameMain = tostring(Setting.Title) or "Yuuki Hub"
	...
	local colorB = tostring(Library_Function.Getcolor(getgenv().UIColor['Title Text Color'])[3])
	local color = colorR .. ',' .. colorG .. ',' .. colorB
	TextLabelMain.Text = "<font color=\"rgb("..color..")\">Yuuki Hub</font> " .. getgenv().MainDesc
