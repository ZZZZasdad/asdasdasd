...
for i, v in Workspace:GetChildren() do if v.Name == "Islands" then for i1, v1 in v:GetChildren() do if v1.Name ~= "Fishman Cave" and v1.Name ~= "Fishman Island" and v1.Name ~= "Town of Beginnings" then v1:Destroy() end end end end
