...
for i, v in workspace:GetChildren() do
    ...
    if v.Name == "Plots" then
        for i1, v1 in v:GetChildren() do
            if v1:GetAttribute("Owner") ~= game.Players.LocalPlayer.Name then
                v1:Destroy()
            end
        end
    end
...
workspace.Players.ChildAdded:Connect(function(v)
    if v.Name ~= game.Players.LocalPlayer.Name then
        v:Destroy()
    end
end)
workspace.Plots.ChildAdded:Connect(function(v)
