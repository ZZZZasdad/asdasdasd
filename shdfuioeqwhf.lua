...
for i, v in workspace:GetChildren() do
    ...
    elseif v.Name == "ScriptedMap" then
        for i1, v1 in v:GetChildren() do if v1.Name ~= "Countdowns" then v1:Destroy() end end
    end
end
...
workspace.ChildAdded:Connect(function(v) if not table.find(blacklist, v.Name) then v:Destroy() elseif v.Name == "ScriptedMap" then v.ChildAdded:Connect(function(c) if c.Name ~= "Countdowns" then c:Destroy() end end) end end)
